...
import {FriendRequest, FriendRequestStatus, UserModel} from '../../../shared/models/user.model';
...
export class ConnectionProfileService {
  ...
  getConnectionUser(id: number): Observable<UserModel> {
    return this.http.get<UserModel>(`${environment.baseApiUrl}/user/${id}`);
  }
